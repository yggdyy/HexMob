...
import pub.pigeon.yggdyy.hexmob.content.ur_circle.ur_spell.UrCoreBeamRenderer
...
object HexMobEntityRenderers {
    fun init() {
        ...
        EntityRendererRegistry.register(HexMobEntities.UR_CORE_BEAM) { context -> UrCoreBeamRenderer(context) }
